...
app.post('/connexion', (req, res) => {
    ...
    const query = `SELECT User.user, User.password, Profile.id, Profile.lastname, Profile.firstname, Profile.zipCode, Profile.city, Profile.linkedin, Profile.photo, Profile.description FROM User, Profile WHERE User = '${userConnection}' AND User.id = Profile.userId`
